...
>>>>>>> 86dfe3594d2ed565d8bf21672793ece67b807e72
    "id" serial primary key,
...
=======
comment on column "game_submissions"."submission_id" is 'The submission that is a player in the linked game.';
comment on column "game_submissions"."game_id" is 'The game that is/was played by the linked player.';
comment on column "game_submissions"."output_url" is 'Link to the output generated by the linked submission.';
alter table "game_submissions" add constraint "game_submissions_submission_id_foreign" foreign key ("submission_id") references "submissions" ("id");
alter table "game_submissions" add constraint "game_submissions_game_id_foreign" foreign key ("game_id") references "games" ("id");
>>>>>>> 86dfe3594d2ed565d8bf21672793ece67b807e72
