...
create table "games_submissions" ("id" serial primary key, "submission_id" integer not null, "game_id" integer not null, "output_url" varchar(255), "created_at" timestamptz not null default CURRENT_TIMESTAMP, "updated_at" timestamptz not null default CURRENT_TIMESTAMP);
